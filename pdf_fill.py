...
# 【重点を置く領域と指導項目】。帳票上の表示順と座標で対応を確認済み。
PLAN_INSTRUCTION_FIELDS = {
    "食事摂取量を適正にする": "チェックボックス100",
    "食塩・調味料を控える": "チェックボックス102",
    "野菜・きのこ・海藻など食物繊維の摂取を増やす": "チェックボックス27",
    "油を使った料理の摂取を減らす": "チェックボックス31",
    "節酒する": "チェックボックス35",
    "間食を減らす": "チェックボックス37",
    "食事時間を規則正しくする": "チェックボックス41",
    "運動処方": "チェックボックス43",
    "日常生活の活動量を増やす": "チェックボックス45",
    "運動時の注意事項を確認する": "チェックボックス48",
    "非喫煙者である": "チェックボックス104",
    "禁煙・節煙の有効性を説明する": "チェックボックス105",
    "禁煙の実施方法を相談する": "チェックボックス106",
    "仕事": "チェックボックス52",
    "余暇": "チェックボックス53",
    "睡眠を確保する": "チェックボックス55",
    "減量する": "チェックボックス57",
    "家庭で歩数・体重・血圧等を計測する": "チェックボックス59",
}

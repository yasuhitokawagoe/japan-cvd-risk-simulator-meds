...
ハードエンドポイントの観察研究値や、危険因子を介した効果と重複するRRは直接掛けない。
"""
...
EXERCISE_EFFECTS = {
    "aerobic_moderate": LifestyleEffect(
        ...
        population="2型糖尿病成人",
        evidence_summary="100 RCT・7,195人。持続的有酸素運動でHbA1c -0.62%。SBP/LDLは全運動様式の保守的下限を採用。",
...
def apply_lifestyle_effects(
    *, sbp: float, ldl: float, a1c: float,
